...
export const AddDialog = ({ isOpen, handleClose, submitedData }) => {
    ...
    return (<div>
        ...
        >
            ...
            <DialogContent>
                <TextField id="standard-basic" label="Title" variant="standard" onChange={(event) => { setTitle(event.target.value) }} />
            ...
            <DialogContent>
                <TextField id="standard-basic" label="Description" variant="standard" onChange={(event) => { setDescription(event.target.value) }} />
            </DialogContent>
            <DialogContent>
